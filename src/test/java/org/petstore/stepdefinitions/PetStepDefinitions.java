...
public class PetStepDefinitions {
	...
	public void i_have_a_valid_pet_payload_with_name_and_status(String name, String status) {
		...
		response = SerenityRest.given().contentType("application/json").body(pet).post("/pet");
	...
	public void i_update_the_pet_status_to(String newStatus) {
		...
		response = SerenityRest.given().contentType("application/json").body(updatedPet).put("/pet");
	...
	public void i_delete_the_pet() {
		response = SerenityRest.given().contentType("application/json").delete("/pet/" + petId);
